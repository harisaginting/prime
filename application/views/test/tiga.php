...
<body>
      <div class="row">
        <div class="col-md-6 offset-md-3">
            <div clas="card">
              <div class="card-header"><h4>Test 3</h4></div>
              <div class="card-body">
                  <div class="col-md-12">
                    <form action="<?= base_url(); ?>/test/tiga" method="post">
                      <div class="form-group">
                        <label>Masukkan angka untuk dicek</label>
                        <input value="<?= $num ?>"  type="number" name="num">
                      </div>
                      <div class="form-group">
                        <button class="btn btn-info" type="submit">Cek angka</button>
                      </div>
                  </form>
                  </div>    
              </div>
