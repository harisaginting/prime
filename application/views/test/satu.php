...
<body>
      <div class="row">
        <div class="col-md-6 offset-md-3">
            <div clas="card">
              <div class="card-header"><h4>Test 1</h4></div>
              <div class="card-body">
                  <div class="col-md-12">
                    <form action="<?= base_url(); ?>/test/satu" method="post">
                      <div class="form-group">
                        <label>Masukkan panjang deret Fibonacci</label>
                        <input value="<?= $long ?>"  type="number" name="fib">
                      </div>
                      <div class="form-group">
                        <button class="btn btn-info" type="submit">Buat Deret Fibonacci</button>
                      </div>
                  </form>
                  </div>    
              </div>
