						              	...
						              	<?php foreach ($deliverables as $key => $value) : ?>
						              		<tr style="background: #bbeaf7;border-top:2px solid #29363d; ">
						              			...
						              			<td >
						              				...
						              				<div data-id="<?= $value['ID_DELIVERABLE'] ?>" style="margin-top: 1px;" class="btn btn-primary col-sm-12  text-left btnissue btn-sm btn-brand"> <i class="fa fa fa-plus"></i><span style="font-size: 10px;"> add issue</span>
													</div>
	    	...
	    	<form method="POST" enctype="multipart/form-data" id="frmissue">
			 ...
			 <div class="modal-body">
                        ...
                        <div class="row">
                        		...
                        		<div class="col-sm-2 offset-md-5 btn btn-sm btn-success hidden" id="btnUpdateissue">Update Issue</div>
                        </div>
